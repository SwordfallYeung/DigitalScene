...
if(is_file(LULINROOT."$img")){
    $rightimg = $cmspath.$img;
}else{
    $rightimg = "%SWFPATH%/spot/$img";
}

$xml .= "<hotspot url=\"".$rightimg."\" volume=\"1\" width=\"\" height=\"\" atv=\"{$spotrow['smartatv']}\" ath=\"{$spotrow['smartath']}\" scale=\"{$spotrow['smartscale']}\" rz=\"{$spotrow['smartrz']}\" ry=\"{$spotrow['smartry']}\" rx=\"{$spotrow['smartrx']}\" zoom=\"True\" name=\"me\" capture=\"False\" enabled=\"True\" visible=\"True\" rotatewithview=\"False\" distorted=\"True\" smoothing=\"True\" refreshrate=\"\" blendmode=\"NORMAL\" zorder=\"1\" />\r\n";
